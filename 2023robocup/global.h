...
if(r>=62&&r<=100) { cout<<"R ENOUGH TO KICK"<<endl;ball_dis4robot=8.2;}//改读取到的半径
//else
//ball_dis4robot = 14;
    //3
...
extern IplImage *show_Image,*Image,* pImage,*ball_Image,*ball_Image_gray,*figure_Image,*field_Image,*field_Image_gray,*goal_canny_Image,*goal_color_dst,*goal_Image_gray,*goal_Image,*ball_Image_gray1;
extern CvSeq *cont;
...
//extern float aa1[3],ww[3],Anglee[3],hh[3];
